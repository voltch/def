...
CONFIG_LOCALVERSION="NOTORIOUS_Kernel_V1.4"
...
# CONFIG_SLUB_DEBUG_LIGHT is not set
...
CONFIG_DEFAULT_IOSCHED="tripndroid"
...
# CONFIG_V_HALL_FOLDING is not set
...
# CONFIG_KEYBOARD_ABOV_FT16XX_TOUCH_VALLEY is not set
